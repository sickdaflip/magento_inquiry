...
class ETWExtensions_Inquiry_Block_Adminhtml_Inquiry_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('shop_name', 'text', array(
            'label' => Mage::helper('inquiry')->__('Shop-Name'),
            'required' => false,
            'name' => 'shop_name',
            'disabled' => 'disabled',
        ));
        ...
        $fieldset->addField('shop_url', 'text', array(
            'label' => Mage::helper('inquiry')->__('Shop-URL'),
            'required' => false,
            'name' => 'shop_url',
            'disabled' => 'disabled',
        ));

        $fieldset->addField('shop_price', 'text', array(
            'label' => Mage::helper('inquiry')->__('Shop-Price'),
            'required' => false,
            'name' => 'shop_price',
            'disabled' => 'disabled',
        ));
