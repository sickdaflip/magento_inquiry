...
class ETWExtensions_Inquiry_Block_Adminhtml_Inquiry_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('shop_name', array(
            'header' => Mage::helper('inquiry')->__('Shop-Name'),
            'align' => 'left',
            'index' => 'shop_name',
        ));

        $this->addColumn('shop_url', array(
            'header' => Mage::helper('inquiry')->__('Shop-URL'),
            'align' => 'left',
            'index' => 'shop_url',
        ));

        $this->addColumn('shop_price', array(
            'header' => Mage::helper('inquiry')->__('Shop-Price'),
            'align' => 'left',
            'index' => 'shop_price',
        ));
        ...
        $this->addColumn('comment', array(
            'header' => Mage::helper('inquiry')->__('Comment'),
            'index' => 'comment',
        ));
